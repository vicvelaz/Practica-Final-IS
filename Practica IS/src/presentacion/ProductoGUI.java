...
public class ProductoGUI extends JPanel implements InterfazGUI {
	...
	private void anadirPanel() {
		...
		enviarBtn.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				String calorias = caloriasField.getText();	
				if ((nombre.length() > 0 && !nombre.equals(" ")) && (precio.length() > 0 && !precio.equals(" ")) && (cantidad.length() > 0 && !cantidad.equals(" ")) && (calorias.length() > 0 && !calorias.equals(" "))) {
					TProducto producto = new TProducto(0, nombre, Double.valueOf(precio), Integer.valueOf(cantidad), Integer.valueOf(calorias), false);
	...
	private void editarPanel() {
		...
		confirmBtn.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				if ((nombre.length() > 0 && !nombre.equals(" ")) && (precio.length() > 0 && !precio.equals(" ")) && (cantidad.length() > 0 && !cantidad.equals(" ")) && (calorias.length() > 0 && !calorias.equals(" "))) {
					TProducto producto = new TProducto(ID, nombre, Double.valueOf(precio), Integer.valueOf(cantidad), Integer.valueOf(calorias), true);
