...
public class FacturaGUI extends JPanel implements InterfazGUI {
			...
			public void actionPerformed(ActionEvent e){
				...
				if (result == JOptionPane.OK_OPTION) {
					...
					if ((IDClienteText.length() > 0 && !IDClienteText.equals(" ")) && (IDEmpleadoText.length() > 0 && !IDEmpleadoText.equals(" "))) {
						//(Integer id, Double descuento, double precio, Date fecha, Integer idEmpleado, Integer idCliente) 
			...
			public void actionPerformed(ActionEvent e){
				...
				if (result == JOptionPane.OK_OPTION) {
					...
					if ((IDProductoText.length() > 0 && !IDProductoText.equals(" ")) && (productoCantidadText.length() > 0 && !productoCantidadText.equals(" "))) {
						//(Integer id, String nombre, double precio, Integer calorias, Integer cantidad, boolean activo)
